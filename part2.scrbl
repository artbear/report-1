...
@para{В замечательной книге @link{"http://yandex.ru/yandsearch?text=%D0%BF%D1%80%D0%BE%D0%B3%D1%80%D0%B0%D0%BC%D0%BC%D0%B8%D1%81%D1%82%20%D0%BF%D1%80%D0%B0%D0%B3%D0%BC%D0%B0%D1%82%D0%B8%D0%BA",Эндрю Ханта "Программист-прагматик"} есть глава посвященная генерации текстов программ. Конкретно сейчас нам интересны "активные генераторы", то есть такие которые на основании модели кода генерируют текст. В принципе, если бы статья посвящалась разработке на языке лисп, вопросов бы не возникло - как и что будет делаться (внимательно смотрим на esrap), но мы в условиях желтого бейсика - значит будем придумывать велосипед.}
@para{Самые продвинутые читатели конечно же вспомнили сейчас о таких программах как yacc, bison, ANTLR. О плюсах которые они дают, ну и конечно же о минусах. И конечно же жогадались что мы сейчас будем делать. Что бы не обманывать их ожиданий скажу - да, мы сейчас напишем генератор лексических анализаторов. Только вот похож он будет больше на waxaye либо PEG.js}
...
@para{Итак, мы начнем с разработки грамматики определяющей язык грамматик которые будет уметь обрабатывать нах генератор.}
...
поймете что это не так. Кстати, еси вы вспомнили после второго прочтения слово "метапрограммирование" - забудьте.}
@para{<ЛирическоеОтступление>}
@para{	К этой задаче и этому языку метапрограммирование - не имеет отношения. Я, вообще, слабо представляю метапрограммирование на 1С. Может быть в 1С версии языка 100500 и появятся макросы, 
